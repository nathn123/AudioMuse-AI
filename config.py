...
# --- Embedder Selection (MAEST vs MusiCNN) ---
# Valid values: "musicnn" (default, legacy) or "maest"
EMBEDDER_TYPE = os.environ.get("EMBEDDER_TYPE", "musicnn").lower()

# MAEST model paths (used when EMBEDDER_TYPE=maest)
MAEST_MODEL_PATH = os.environ.get("MAEST_MODEL_PATH", "/app/model/discogs-maest-30s-pw-519l-2.onnx")
MAEST_JSON_PATH = os.environ.get("MAEST_JSON_PATH", "/app/model/discogs-maest-30s-pw-519l-2.json")
MAEST_INPUT_NAME = os.environ.get("MAEST_INPUT_NAME", "melspectrogram")
...
EMBEDDING_DIMENSION = _compute_embedding_dim()

# MAEST mood/genre labels (519 Discogs genre taxonomy)
MAEST_MOOD_LABELS = [
    ...
    'Blues---Memphis Blues', 'Blues---Modern Electric Blues',
    'Blues---Piano Blues', 'Blues---Piedmont Blues', 'Blues---Texas Blues',
    'Blues---Urban Blues', 'Blues---Zydeco', 'Childrens Music---Lullabies',
    'Childrens Music---Sing-Along', 'Childrens Music---Stories',
    'Classical---Avant-Garde', 'Classical---Baroque Era',
    'Classical---Chamber Music', 'Classical---Choral',
    'Classical---Classical Era', 'Classical---Contemporary',
    'Classical---Early Music', 'Classical---Expressionist',
    'Classical---High Classical', 'Classical---Historical',
    'Classical---Impressionist', 'Classical---Medieval',
    'Classical---Minimalism', 'Classical---Modern',
    'Classical---Neo-Classical', 'Classical---Neo-Romantic',
    'Classical---Opera', 'Classical---Orchestral',
    'Classical---Organ', 'Classical---Post-Modern',
    'Classical---Post-Romantic', 'Classical---Renaissance',
    'Classical---Romantic Era', 'Classical---Serial',
    'Classical---Symphony', 'Country---Alternative Country',
    'Country---Americana', 'Country---Bluegrass',
    'Country---Contemporary Bluegrass', 'Country---Contemporary Country',
    'Country---Country Blues', 'Country---Country Folk',
    'Country---Country Gospel', 'Country---Country Rock',
    'Country---Honky Tonk', 'Country---Nashville Sound',
    'Country---Neo-Traditional Folk', 'Country---Outlaw Country',
    'Country---Progressive Bluegrass', 'Country---Texas Country',
    'Country---Traditional Bluegrass', 'Country---Traditional Country',
    'Easy Listening---Background Music', 'Easy Listening---Bossa Nova',
    'Easy Listening---Easy Listening', 'Easy Listening---Elevator Music',
    'Easy Listening---Exotica',
    'Easy Listening---Instrumental Pop',
    'Easy Listening---Lounge', 'Easy Listening---Middle of the Road',
    'Easy Listening---Orchestral Easy Listening',
    'Easy Listening---Space Age Pop', 'Easy Listening---Tango',
    'Electronic---Abstract', 'Electronic---Acid',
    'Electronic---Acid House', 'Electronic---Ambient',
    'Electronic---Avantgarde', 'Electronic---Bass Music',
    'Electronic---Beatdown', 'Electronic---Big Beat',
    'Electronic---Breakbeat', 'Electronic---Breakcore',
    'Electronic---Broken Beat', 'Electronic---Chillwave',
    'Electronic---Chiptune', 'Electronic---Coldwave',
    'Electronic---Contemporary', 'Electronic---Dark Ambient',
    'Electronic---Darkwave', 'Electronic---Deep House',
    'Electronic---Disco', 'Electronic---Donk',
    'Electronic---Downtempo', 'Electronic---Drone',
    'Electronic---Drum n Bass', 'Electronic---Dub',
    'Electronic---Dub Techno', 'Electronic---Dubstep',
    'Electronic---EDM', 'Electronic---Electro',
    'Electronic---Electro House', 'Electronic---Electroclash',
    'Electronic---Electronic', 'Electronic---Euro House',
    'Electronic---Eurodance', 'Electronic---Experimental',
    'Electronic---Footwork', 'Electronic---Funky House',
    'Electronic---Future Jazz', 'Electronic---Gabber',
    'Electronic---Garage House', 'Electronic---Ghetto',
    'Electronic---Glitch', 'Electronic---Goa Trance',
    'Electronic---Grime', 'Electronic---Hands Up',
    'Electronic---Happy Hardcore', 'Electronic---Hard House',
    'Electronic---Hard Techno', 'Electronic---Hard Trance',
    'Electronic---Hardstyle', 'Electronic---Hi NRG',
    'Electronic---House', 'Electronic---IDM',
    'Electronic---Illbient', 'Electronic---Industrial',
    'Electronic---Italo Disco', 'Electronic---Italo House',
    'Electronic---Jungle', 'Electronic---Krautrock',
    'Electronic---Leftfield', 'Electronic---Liquid Funk',
    'Electronic---Minimal', 'Electronic---Minimal Techno',
    'Electronic---Modern Classical', 'Electronic---Musique Concrete',
    'Electronic---Neofolk', 'Electronic---New Age',
    'Electronic---New Beat', 'Electronic---New Wave',
    'Electronic---Noise', 'Electronic---Nu-Disco',
    'Electronic---Power Electronics', 'Electronic---Progressive House',
    'Electronic---Progressive Trance', 'Electronic---Psy-Trance',
    'Electronic---Rhythmic Noise', 'Electronic---Synth-pop',
    'Electronic---Tech House', 'Electronic---Techno',
    'Electronic---Trance', 'Electronic---Tribal',
    'Electronic---Trip Hop', 'Electronic---UK Garage',
    'Electronic---Vaporwave', 'Folk World Country---African',
    'Folk World Country---African Folk', 'Folk World Country---Andean',
    'Folk World Country---Appalachian', 'Folk World Country---Arabesque',
    'Folk World Country---Asian', 'Folk World Country---Baila',
    'Folk World Country---Bhangra', 'Folk World Country---Bossa Nova',
    'Folk World Country---Calypso', 'Folk World Country---Candombe',
    'Folk World Country---Caribbean', 'Folk World Country---Celtic',
    'Folk World Country---Central Asian', 'Folk World Country---Chutney',
    'Folk World Country---Cumbia', 'Folk World Country---Dangdut',
    'Folk World Country---Drinking Songs', 'Folk World Country---Enka',
    'Folk World Country---Eurasian', 'Folk World Country---European',
    'Folk World Country---Fado', 'Folk World Country---Flamenco',
    'Folk World Country---Folk', 'Folk World Country---Folk Rock',
    'Folk World Country---Gamelan', 'Folk World Country---Gospel',
    'Folk World Country---Griot', 'Folk World Country---Halk',
    'Folk World Country---Hawaiian', 'Folk World Country---Highlife',
    'Folk World Country---Hindustani', 'Folk World Country---Indian',
    'Folk World Country---Indo-Pop', 'Folk World Country---Japanese',
    'Folk World Country---Jewish', 'Folk World Country---Karaoke',
    'Folk World Country---Kayokyoku', 'Folk World Country---Khaleeji',
    'Folk World Country---Krautrock', 'Folk World Country---Latin',
    'Folk World Country---Latin Jazz', 'Folk World Country---Mambo',
    'Folk World Country---Mariachi', 'Folk World Country---Mbalax',
    'Folk World Country---Merengue', 'Folk World Country---Middle Eastern', 'Folk World Country---Mizrahi',
    'Folk World Country---Música Criolla', 'Folk World Country---Música Popular Brasileira',
    'Folk World Country---Nederlandse', 'Folk World Country---Nordic',
    'Folk World Country---Nueva Cancion', 'Folk World Country---Oi',
    'Folk World Country---Pacific', 'Folk World Country---Pasodoble',
    'Folk World Country---Polka', 'Folk World Country---Pop Folk',
    'Folk World Country---Rai', 'Folk World Country---Ranchera',
    'Folk World Country---Rumba', 'Folk World Country---Salsa',
    'Folk World Country---Samba', 'Folk World Country---Sara',
    'Folk World Country---Sea Shanties', 'Folk World Country---Sega',
    'Folk World Country---Sertanejo', 'Folk World Country---Soca',
    'Folk World Country---Son', 'Folk World Country---Soukous',
    'Folk World Country---South Asian', 'Folk World Country---Southeast Asian',
    'Folk World Country---Tango', 'Folk World Country---Tarab',
    'Folk World Country---Tejano', 'Folk World Country---Tropical',
    'Folk World Country---Twmpath', 'Folk World Country---Vallenato',
    'Folk World Country---Villancicos', 'Folk World Country---Western',
    'Folk World Country---World', 'Folk World Country---Zamba',
    'Folk World Country---Zouk', 'Funk Soul---Afrobeat',
    'Funk Soul---Bayou Funk', 'Funk Soul---Boogie',
    'Funk Soul---Chicago Soul', 'Funk Soul---Deep Soul',
    'Funk Soul---Detroit Soul', 'Funk Soul---Disco',
    'Funk Soul---Funk', 'Funk Soul---Go-Go', 'Funk Soul---Gospel',
    'Funk Soul---Gospel Soul', 'Funk Soul---Jazz-Funk',
    'Funk Soul---Memphis Soul', 'Funk Soul---Motown',
    'Funk Soul---Neo Soul', 'Funk Soul---New Orleans Funk',
    'Funk Soul---New Orleans Soul', 'Funk Soul---Northern Soul',
    'Funk Soul---P.Funk', 'Funk Soul---Philly Soul',
    'Funk Soul---Psychedelic Funk', 'Funk Soul---Psychedelic Soul',
    'Funk Soul---Rhythm Blues', 'Funk Soul---Soul',
    'Funk Soul---Southern Soul', 'Funk Soul---UK Street Soul',
    'Hip Hop---Boom Bap', 'Hip Hop---Bounce',
    'Hip Hop---British', 'Hip Hop---Chopped Screwed',
    'Hip Hop---Cloud Rap', 'Hip Hop---Conscious',
    'Hip Hop---Crunk', 'Hip Hop---DJ Tools',
    'Hip Hop---Dirty South', 'Hip Hop---Drill',
    'Hip Hop---Electro', 'Hip Hop---G-Funk',
    'Hip Hop---Gangsta', 'Hip Hop---Grime',
    'Hip Hop---Hardcore Hip-Hop', 'Hip Hop---Horrorcore',
    'Hip Hop---Hyphy', 'Hip Hop---Instrumental',
    'Hip Hop---Jazzy Hip-Hop', 'Hip Hop---Miami Bass',
    'Hip Hop---Midwest', 'Hip Hop---Pop Rap',
    'Hip Hop---Ragga HipHop', 'Hip Hop---Screw',
    'Hip Hop---Thug Rap', 'Hip Hop---Trap',
    'Hip Hop---Trip Hop', 'Hip Hop---Turntablism',
    'Hip Hop---Underground', 'Hip Hop---West Coast',
    'Jazz---Acid Jazz', 'Jazz---Afro-Cuban Jazz',
    'Jazz---Avant-garde Jazz', 'Jazz---Big Band',
    'Jazz---Bop', 'Jazz---Cool Jazz', 'Jazz---Crossover Jazz',
    'Jazz---Dixieland', 'Jazz---Easy Listening',
    'Jazz---Free Improvisation', 'Jazz---Free Jazz',
    'Jazz---Fusion', 'Jazz---Gypsy Jazz',
    'Jazz---Hard Bop', 'Jazz---Jazz Blues',
    'Jazz---Jazz Rock', 'Jazz---Latin Jazz',
    'Jazz---Modal', 'Jazz---Post Bop',
    'Jazz---Post-Modal', 'Jazz---Ragtime',
    'Jazz---Smooth Jazz', 'Jazz---Soul-Jazz',
    'Jazz---Swing', 'Jazz---Third Stream',
    'Latin---Alternativo Latino', 'Latin---Balada',
    'Latin---Bolero', 'Latin---Bossa Nova',
    'Latin---Cha-Cha', 'Latin---Criolla',
    'Latin---Cuban', 'Latin---Cumbia',
    'Latin---Dembow', 'Latin---Flamenco',
    'Latin---Guaracha', 'Latin---Joropo',
    'Latin---Latin', 'Latin---Latin Pop',
    'Latin---Mambo', 'Latin---Mariachi',
    'Latin---Merengue', 'Latin---Milonga',
    'Latin---Norteño', 'Latin---Nueva Cancion',
    'Latin---Pachanga', 'Latin---Pop Latino',
    'Latin---Porro', 'Latin---Ranchera',
    'Latin---Rumba', 'Latin---Salsa',
    'Latin---Samba', 'Latin---Tango',
    'Latin---Tejano', 'Latin---Vallenato',
    'Latin---Zamba', 'Pop---Bubblegum',
    'Pop---Chamber Pop', 'Pop---Christian Pop',
    'Pop---Dance Pop', 'Pop---Dream Pop',
    'Pop---Electro Pop', 'Pop---Europop',
    'Pop---Indie Pop', 'Pop---J-Pop',
    'Pop---K-Pop', 'Pop---Latin Pop',
    'Pop---New Wave', 'Pop---Pop Punk',
    'Pop---Pop Rap', 'Pop---Pop Rock',
    'Pop---Progressive Pop', 'Pop---Psychedelic Pop',
    'Pop---Singer-Songwriter', 'Pop---Soft Rock',
    'Pop---Sunshine Pop', 'Pop---Synth Pop',
    'Pop---Teen Pop', 'Pop---Traditional Pop',
    'Pop---Vocal Pop', 'Pop---Worship',
    'R&B---Contemporary R&B', 'R&B---Doo Wop',
    'R&B---Funk', 'R&B---Neo Soul',
    'R&B---New Jack Swing', 'R&B---Psychedelic',
    'R&B---Quiet Storm', 'R&B---Rhythm Blues',
    'R&B---Soul', 'R&B---Swingbeat',
    'R&B---Urban', 'Reggae---Cumbia',
    'Reggae---Dancehall', 'Reggae---Dub',
    'Reggae---Dub Poetry', 'Reggae---Lovers Rock',
    'Reggae---Ragga', 'Reggae---Ragga HipHop',
    'Reggae---Rapso', 'Reggae---Ras',
    'Reggae---Reggae', 'Reggae---Reggae Gospel',
    'Reggae---Reggae Pop', 'Reggae---Rocksteady',
    'Reggae---Roots Reggae', 'Reggae---Ska',
    'Reggae---Soca', 'Rock---Acoustic',
    'Rock---Alternative Rock', 'Rock---Art Rock',
    'Rock---Blues Rock', 'Rock---British Invasion',
    'Rock---Classic Rock', 'Rock---Country Rock',
    'Rock---Death Metal', 'Rock---Doom Metal',
    'Rock---Folk Rock', 'Rock---Glam',
    'Rock---Gothic Metal', 'Rock---Grunge',
    'Rock---Hair Metal', 'Rock---Hard Rock',
    'Rock---Hardcore', 'Rock---Heavy Metal',
    'Rock---Indie Rock', 'Rock---Industrial',
    'Rock---Jam Band', 'Rock---Math Rock',
    'Rock---Metal', 'Rock---Metalcore',
    'Rock---Neo-Prog', 'Rock---New Wave',
    'Rock---Noise', 'Rock---Nu Metal',
    'Rock---Pop Punk', 'Rock---Post Hardcore',
    'Rock---Post Metal', 'Rock---Post Punk',
    'Rock---Post Rock', 'Rock---Power Metal',
    'Rock---Power Pop', 'Rock---Prog Rock',
    'Rock---Progressive Metal', 'Rock---Psychedelic Rock',
    'Rock---Punk', 'Rock---Rock',
    'Rock---Rock Roll', 'Rock---Shoegaze',
    'Rock---Sludge Metal', 'Rock---Southern Rock',
    'Rock---Stoner Metal', 'Rock---Stoner Rock',
    'Rock---Symphonic Metal', 'Rock---Thrash',
    'Rock---Traditional Metal', 'Spoken Word---Audiobook',
    'Spoken Word---Comedy', 'Spoken Word---Dialogue',
    'Spoken Word---Field Recording', 'Spoken Word---Interview',
    'Spoken Word---Monologue', 'Spoken Word---Poetry',
    'Spoken Word---Radio Play', 'Spoken Word---Speech',
